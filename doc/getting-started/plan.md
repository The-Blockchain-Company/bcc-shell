...
(see [Github milestones](https://github.com/The-Blockchain-Company/bcc-shell/milestones?direction=asc&sort=title&state=open))

|     | Id  | depends on | title | description | deliverable |
|-----|-----|------------|-------|-------------|-------------|
| [_] | [**NOD001**](https://github.com/The-Blockchain-Company/bcc-shell/milestone/7) |  | Klarity IPC complete  | Inter process communication, Klarity uses this to perform initial configuration agreements between wallet and also for clean shutdowns (node or wallet). Wallet team needs this in order to communicate with Klarity - full Klarity integration  | IPC implementation and documentation |
...
|     | Id  | depends on | title | description | deliverable |
|-----|-----|------------|-------|-------------|-------------|
| [x] | [**NOD002**](https://github.com/The-Blockchain-Company/bcc-shell/milestone/8) |  | Configuration complete for batch mode block validation  | Prove that the cofiguration system is valid for the needs. This is a design (configuration subsystem in node shell) validation point. (25/03 - Dev is in progress). Could be demoed if compelte.  | Valid configuration for batch mode block validation |
| [x] | T2.1.1 |  | Assist ledger team with integration (#46) | dependency: bcc-ledger | bcc-ledger integrated with bcc-shell |

|     | Id  | depends on | title | description | deliverable |
|-----|-----|------------|-------|-------------|-------------|
| [_] | [**NOD003**](https://github.com/The-Blockchain-Company/bcc-shell/milestone/9) |  | Node shell as a library | "Design validation for features, configuration and is used for wallet and node 
...
| [_] | T3.1.3 | T3.1.1 | Redesign modules, define API | only expose functions, types in API | bcc-shell as a library |
| [x] | T3.1.4 | T3.1.3 | Documentation |  | Documentation for the shell |

|     | Id  | depends on | title | description | deliverable |
|-----|-----|------------|-------|-------------|-------------|
| [_] | [**NOD004**](https://github.com/The-Blockchain-Company/bcc-shell/milestone/10) | NOD003 | Miminal integration with wallet BE - Wallet BE team & Node Shell  | No Klarity IPC, minimal logging output, partial configuration is complete, completed features framework  | wallet BE integrated with shell |
| [_] | E4.1   |  | Assist with integration | dependency: klarity | klarity integrated with shell |
| [_] | T4.1.1 |  | Assist with integration (#78) | dependency: klarity |  |

|     | Id  | depends on | title | description | deliverable |
|-----|-----|------------|-------|-------------|-------------|
| [_] | [**NOD005**](https://github.com/The-Blockchain-Company/bcc-shell/milestone/11) | NOD002, NOD003 | Minimal integration with Node - Ledger, Consensus & Node Shell | No Klarity IPC, minimal logging output, partial configuration is complete, completed features framework  | Ledger, consensus integrated with node shell |
| [_] | E5.1   |  | Assist with integration |  |  |
| [x] | T5.1.1 |  | Assist with integration | dependency: bcc-ledger |  |
| [_] | T5.1.2 |  | Assist with integration | dependency: consensus |  |
| [_] | T5.1.3 |  | Assist with integration | dependency: network |  |

|     | Id  | depends on | title | description | deliverable |
|-----|-----|------------|-------|-------------|-------------|
| [_] | [**NOD006**](https://github.com/The-Blockchain-Company/bcc-shell/milestone/12) | NOD004 | Maximum integration with wallet BE - Wallet BE team & Node Shell  | Minimal + full configuration, full logging coverage for components  | Working Wallet backend that is being run by Node Shell |
| [_] | E6.1   |  | Requirements |  |  |
...
|     | Id  | depends on | title | description | deliverable |
|-----|-----|------------|-------|-------------|-------------|
| [_] | [**NOD007**](https://github.com/The-Blockchain-Company/bcc-shell/milestone/13) | NOD005 | Maximum integration with Node - Ledger, Consensus & Node Shell | Minimal + full configuration, full logging coverage for components for node  | Working Ledger that is being run by Node Shell |
| [_] | E7.1   |  | Requirements |  |  |
...
|     | Id  | depends on | title | description | deliverable |
|-----|-----|------------|-------|-------------|-------------|
| [_] | [**NOD008**](https://github.com/The-Blockchain-Company/bcc-shell/milestone/14) | NOD006, NOD007 | Integration with 'Update system' - with Klarity, Wallet BE & Node. Launcher and update mechansim complete  | Launcher now functions with rest of the 'update system'.  Launcher component which is used as part of the 'update system' - cross cutting across all major components | Full wallet/node working. Update system that returns and installs updates and fully working Klarity with Wallet, and Node on the other side. |
...
| [_] | E8.4   | T8.3.1 | Integration launcher, Klarity |  | Fully working wallet and node |
| [_] | T8.4.1 |  | Integration of Klarity and launcher |  |  |
