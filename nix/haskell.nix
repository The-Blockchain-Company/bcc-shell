#TODO must change depracated attributed noted in fixme below
  ...
  pkgSet = haskell-nix.cabalProject (lib.optionalAttrs stdenv.hostPlatform.isWindows {
    ...
    modules = [
      ...
      }
      {
        ...
        packages.bcc-launcher.components.tests.bcc-launcher-test.keepSource = true;
      ...
      (lib.optionalAttrs profiling {
        ...
        packages.bcc-launcher.components.exes.bcc-launcher.enableExecutableProfiling = true;
      ...
      (lib.optionalAttrs coverage {
        packages.bcc-launcher.components.library.doCoverage = true;
        packages.bcc-shell.components.library.doCoverage = true;
      })
    ];
