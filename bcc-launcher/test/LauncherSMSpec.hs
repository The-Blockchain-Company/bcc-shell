...
import           Bcc.Shell.Launcher (BccWalletExitCode (..),
...
type UpdateExitCode = BccWalletExitCode
type WalletExitCode = BccWalletExitCode
...
actionToConcrete :: Action r -> BccWalletExitCode
...
-- | Abstract to concrete.
responseToConcrete :: Response r -> BccWalletExitCode
...
-- | Abstract to concrete.
concreteToResponse :: BccWalletExitCode -> Response r
...
deriving instance ToExpr BccWalletExitCode
...
data InputOutputMessages = InputOutputMessages
   { returnedWalletExitCodes  :: ![BccWalletExitCode]
   , executionWalletExitCodes :: ![BccWalletExitCode]
...
launcherSM = StateMachine
  ...
  where
    ...
    mGenerator _            = Just $ oneof
        [ RunUpdateAction <$> arbitraryBccWalletExitCode <*> arbitraryBccWalletExitCode
        , WalletSafeModeAction <$> arbitraryBccWalletExitCode
        , WalletNormalModeAction <$> arbitraryBccWalletExitCode
        ]
    ...
    mSemantics (RunUpdateAction updateFunctionDEC launcherFunctionDEC)  =
        ...
        in
            concreteToResponse <$>
                handleBccWalletExitCode updateRunner restartRunner RunUpdate
    ...
    mSemantics (WalletSafeModeAction launcherFunctionDEC)               =
        let
         ...
         in
            concreteToResponse <$>
                handleBccWalletExitCode doNotUse restartRunner RestartInGPUSafeMode
    ...
    mSemantics (WalletNormalModeAction launcherFunctionDEC)             =
        ...
        in
            concreteToResponse <$>
                handleBccWalletExitCode doNotUse restartRunner RestartInGPUNormalMode
...
-- | Correct generation of @BccWalletExitCode@.
arbitraryBccWalletExitCode :: Gen BccWalletExitCode
arbitraryBccWalletExitCode = oneof
    [ return RunUpdate
