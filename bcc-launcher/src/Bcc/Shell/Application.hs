...
instance Show ApplicationError where
    show ApplicationAlreadyRunningException = "Klarity application is already running. \
...
-- For example, somebody has two installations, one in /home/user/bcc-sl-2.0 and
-- the other in /home/user/bcc-sl-1.33. Each instance of the program that runs knows
...
-- one in /home/user/bcc-sl-2.0-installation-1 and one
-- in /home/user/bcc-sl-2.0-installation-2. Perhaps ports will still conflict.
