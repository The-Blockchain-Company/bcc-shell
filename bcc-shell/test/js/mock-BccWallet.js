...
// This runs the klarity-ipc executable in the same way that Klarity would run klarity.
// It needs node and klarity-ipc on the PATH to run.
...
function main() {
  ...
  const proc = child_process.spawn("klarity-ipc", [port],
  ...
  proc.on("message", function(msg) {
    ...
    // See BccNode.js in Klarity for the message types in use.
    if (msg.Started) {
